        ...
        <div className=" my-[4rem]">
          <div className="">
            <p className="text-[0.84rem] my-4">
              ...
              officia deleniti, ea possimus amet, atque minima tenetur, commodi
              dignissimos doloremque debitis accusamus? Molestiae iste autem
              eius explicabo incidunt quisquam cumque. Lorem ipsum dolor sit
              amet consectetur adipisicing elit. Quia alias at laudantium ab
              numquam, porro magnam corrupti! Nihil, quasi similique, deserunt
              quae labore inventore pariatur hic, nobis molestiae dolore animi.
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed illo
              hic provident vitae minus iure possimus tempora perspiciatis ut
              earum ad, aliquam consectetur, est excepturi quas natus
              voluptatem, iste doloribus! Lorem ipsum dolor sit amet consectetur
              adipisicing elit.
            </p>
          </div>
          <div className="mt-[3rem]">
            <p className="text-[0.84rem] my-4">
              ...
              sit amet consectetur adipisicing elit. Quia alias at laudantium ab
              numquam, porro magnam corrupti! Nihil, quasi similique, deserunt
              quae labore inventore pariatur hic, nobis molestiae dolore animi.
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed illo
              hic provident vitae minus iure possimus tempora perspiciatis ut
              earum ad, aliquam consectetur, est excepturi quas natus
              voluptatem, iste doloribus! Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Commodi quia temporibus autem eligendi,
              molestias doloribus, dolorum cumque vel illo odio tempora quos
              praesentium impedit nostrum, in rerum neque dignissimos expedita?
            </p>
          </div>
        ...
        <div className="grid grid-cols-3 md:grid-cols-3 my-[3rem] gap-7">
          ...
          <div className="col-span-2">
            ...
            <p className="text-[0.84rem] my-4">
              ...
              consectetur, est excepturi quas natus voluptatem, iste doloribus!
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi
              quia temporibus autem eligendi, molestias doloribus, dolorum
              cumque vel illo odio tempora quos praesentium impedit nostrum, in
              rerum neque dignissimos expedita?
            </p>
